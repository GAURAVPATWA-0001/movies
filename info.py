...
API_ID = int(environ.get('API_ID', '26905889'))
API_HASH = environ.get('API_HASH', 'c18fa0648fce5d1760fbcb73cf73c1db')
BOT_TOKEN = environ.get('BOT_TOKEN', '7124511196:AAExrGPknnBRzSqaw8Ovbm5oAZmFKks5q_A')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '').split()]
USERNAME = environ.get('USERNAME', "https://t.me/Gflixmovies_bot") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-6172890445'))
...
DATABASE_NAME = environ.get('DATABASE_NAME', "GflixMoviesBot")
